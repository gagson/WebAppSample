        ...
        try (PrintWriter out = response.getWriter()) {
            if ((login != null) && (type != null) && (homeFolder != null)) {
                out.println("<!DOCTYPE html>\n"
                        ...
                        + "                    <div class=\"col-md-3\">\n"
                        + "                        <input type=\"text\" name=\"kw1\" class=\"form-control\" required>\n"
                        + "                    </div>\n"
                        ...
                        + "                    <div class=\"col-md-3\">\n"
                        + "                        <input type=\"text\" name=\"kw2\" class=\"form-control\" required>\n"
                        + "                    </div>\n"
                        + "                    <label class=\"col-md-2\"></label>\n"
                        + "                </div>\n"
                        ...
                        + "                    <div class=\"col-md-3\">\n"
                        + "                        <input type=\"text\" name=\"kw3\" class=\"form-control\" required>\n"
                        + "                    </div>\n"
                        + "                    <label class=\"col-md-2\"></label>\n"
                        + "                </div>\n"
                        + "                <div class=\"row p-1\"></div>\n"
